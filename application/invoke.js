...
async function main() {
    try {
        ...
        const contract = network.getContract("infinity");

        // Submit the specified transaction.

        // addUser Test : "invoketest@gmail.com"
        await contract.submitTransaction("addUser", "nike-sneakersDID-FUNCTION-EIJNGWEO-HASH");
        console.log("Transaction has been submitted");
        // setTimeout(function () {}, 1000);

        var result = await contract.evaluateTransaction(
            "ReadMyDraw",
            "nike-sneakersDID-FUNCTION-EIJNGWEO-HASH"
        );
        console.log(
